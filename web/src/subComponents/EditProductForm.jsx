...
function EditProductForm({
  ...
  const handleEdit = () => {
    // To do: edit fn
    setLoading(true);
    db.editProduct(token, { ...formData, productId: id })
      .then((res) => {
        if (res.status) {
          toast.success(res.message);
        } else {
  ...
  return (
    <div className="mx-5 lg:mx-10 mt-5 py-5 lg:py-10 px-4 lg:px-7 rounded shadow-xl bg-gray-100">
      <form
      ...
      >
        <div className="flex flex-col">
          ...
          <input
            ...
            onChange={handleEditProductFormValidate}
