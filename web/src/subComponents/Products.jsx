...
function Products() {
  ...
  async function handleProductFormSubmit() {
    ...
    if (!document.getElementById("productImage").files.length > 0) {
      ...
      document.getElementById("productImage").files[0].size > 2000000
    ) {
          ...
          <div className="mx-5 lg:mx-10 mt-3 lg:mt-5 flex justify-between items-center">
            ...
            <div>
              <button
                onClick={showAddForm}
                title="Add product"
                className="mr-2 lg:mr-4 p-1.5 lg:px-6 lg:py-1 cursor-pointer bg-green-800 hover:bg-green-700 text-white text-base lg:text-lg rounded"
              >
                <IoMdAdd />
              </button>
              <button
                onClick={showView}
                title="View products"
                className="p-1.5 lg:px-6 lg:py-1 cursor-pointer bg-green-800 hover:bg-green-700 text-white text-base lg:text-lg rounded"
              >
                <MdGridView />
              </button>
            </div>
            ...
            <div className="mx-5 lg:mx-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-5">
              {products.length > 0
                ? products.map((product) => (
                    <div
                      key={product._id}
                      className="rounded shadow-xl ring-1 ring-gray-100 px-3 lg:px-6 py-5 bg-gray-100"
                    >
                      <img
                        ...
                        alt=""
                      />
                      <h1 className="font-bold mt-4 text-base lg:text-base">
                        {product.title}
                      </h1>
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <div>
                          ...
                          <p className="font-semibold text-sm lg:text-sm">
                            {product.price} KES
                          </p>
                        </div>
                        <div>
                          <p className="text-gray-400 text-xs lg:text-sm text-left mt-2">
                            Quantity
                          </p>
                          <p className="font-semibold text-sm lg:text-sm text-right">
                            {product.quantity}
                          </p>
                        </div>
                      </div>
                      <button
                        ...
                        w-full 
                        cursor-pointer 
                        text-sm lg:text-sm hover:text-white 
              ...
              >
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={handleProductFormValidate}
                    className="text-sm rounded p-1 px-3 mt-2 border-1 border-gray-400 lg:border-gray-300 outline-0"
                    type="text"
                    id="productName"
                    name="productName"
                  />
