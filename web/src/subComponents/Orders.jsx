        ...
        <div className="mx-5 lg:mx-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-3 lg:mt-5">
            <div className='border-1 border-gray-300 rounded shadow-lg p-5'>
                ...
                <div className='flex justify-between items-center border-b-1 border-gray-300 pb-3'>
                    <h1 className='text-gray-400 text-xs lg:text-sm'>ABd4567yZTY</h1>
                ...
                <div className='flex justify-between'>
                    <div>
                        <p className='text-gray-400 text-xs lg:text-sm mt-2'>Quantity</p>
                ...
                <p className='text-sm lg:text-base'>Kakamega, Lupe, Near Mahiakalo Primary</p>
