    ...
    <>
      <Navbar user={user} activePage={"dashboard"}>
        <div className="mx-4 lg:mx-10 mt-5 pb-10">
          ...
          <h1 className="text-3xl font-extrabold mb-5 text-green-600 text-center lg:text-left">
            {vendorStats.totalRevenue}
          </h1>

          <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="pt-1 lg:shadow-xl ring-2 lg:ring-1 bg-gray-100 ring-gray-200 rounded flex flex-col justify-between">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-start justify-between w-full mt-5 lg:mt-10 bg-gray-100">
            ...
            <div className="shadow-sm lg:shadow-xl ring-2 lg:ring-1 ring-gray-200 rounded w-full lg:w-2/6 ml-0 lg:ml-4 bg-gray-100">
              <h1 className="text-base font-semibold mt-0 mb-0 border-b-1 border-gray-300 lg:border-gray-200 px-5 pt-3 pb-3">
                Best sellers
              </h1>
              <div className="pt-5">
