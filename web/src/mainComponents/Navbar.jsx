        ...
        <>
           <div className=' bg-gray-100 flex w-full h-max' style={{minHeight: '100vh'}}>
                 ...
                 <div className='bg-green-900 h-screen w-2/12 fixed top-0 left-0'>
                    ...
                    <div className='px-3 mx-5 rounded mt-2 text-white text-sm flex items-center justify-between cursor-pointer hover:bg-white hover:text-green-900 py-2' onClick={() => {window.location.href = '/products'}}>
                        <div className='flex items-center'>
                            <FaShop />
                    ...
                    <div className='px-3 mx-5 rounded mt-2 text-white text-sm flex items-center justify-between cursor-pointer hover:bg-white hover:text-green-900 py-2' onClick={() => {window.location.href = '/orders'}}>
                        <div className='flex items-center'>
                            <PiFarmFill />
