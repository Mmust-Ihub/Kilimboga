      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 420, padding: 20 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <p style={{ textAlign: "center", margin: 0, fontSize: 13, color: "rgba(240,253,244,0.5)" }}>
              Verify your account{" "}
              <button onClick={() => navigate("/verify")} style={{ background: "transparent", border: "none", color: "#4ADE80", cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: "'DM Sans',sans-serif" }}>
                here
              </button>
            </p>
          </div>
