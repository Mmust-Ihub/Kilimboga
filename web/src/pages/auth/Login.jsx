...
import { ToastProvider, useToast } from '/home/wanyungu/Desktop/code/Kilimboga/web/src/components/ToastProvider.jsx';
...
export const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    const { error } = validate("login", { email, password: pass });
    if (error) {
