...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  return (
    <aside style={{
      width: w, height: "100vh", position: "sticky", top: 0, background: "var(--surface)", borderRight: "1px solid var(--border)",
        ...
        {nav.map(item => {
          ...
          return (
            <button key={item.route} onClick={() => navigate(item.route)}
              ...
              style={{
                width: "100%", display: "flex", alignItems: "center", gap: 12, padding: collapsed ? "12px 16px" : "11px 14px",
